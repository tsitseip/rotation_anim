...
/**
 * Represents a 3D rotating pyramid rendered manually using simple rotation
 * and projection math. Implements animation with configurable parameters such as speed,
 * zoom, trail length, and color.
 */

public class Pyramid3D implements Figure3D {
    ...
    /**
     * The 3D coordinates of the pyramid's vertices.
     */
    ...
    /**
     * Defines edges between vertices to form a pyramid structure.
     */
    ...
    /**
     * Renders the pyramid based on given rotation angles and opacity.
     *
     ...
     */
    private void drawPyramid(Graphics g, int width, int height, double[] angles, float alpha) {
    ...
    /**
     * Renders the pyramid and its trail.
     *
     * @param g      The graphics context.
    ...
    public void render(Graphics g, int width, int height) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            drawPyramid(g, width, height, a, alpha);
        }
    }
